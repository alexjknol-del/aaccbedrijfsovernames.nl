...
Site: aaccbedrijfsovernames.nl, statische site via build.py, gedeployed met Cloudflare Pages.
...
## Na elke wijziging
python3 build.py draaien en controleren dat de build slaagt.
Controleren op aanspreekvorm, em-dashes en geldige JSON-LD.
Committen en pushen. Cloudflare bouwt en publiceert automatisch.
